...
function ricegrowthstages(code, ml, year, code_biweekly) {
 ...
 var MOD13Q1_APPLIED1 = ee.ImageCollection("MODIS/006/MOD13Q1");
  ...
  var name_file_fusion = 'FusionGEEBiWeekly_V2_'+ ml +'_ALL-' + year +'_' + date_APPLIED1_code + '_W' + date_APPLIED1_data.week + '-' + date_APPLIED1_data.number ;
  Export.image.toDrive({
    image: classified_S2_LS8_MOD13Q1_rename_fusion_mask_APPLIED1_SLOPE,
    folder : 'FusionGEEBiWeekly_V2_'+ml,
    crs:'EPSG:32748' ,
...
ricegrowthstages('13','SVM','2019','21');
ricegrowthstages('13','SVM','2019','22');
ricegrowthstages('13','SVM','2019','23');
ricegrowthstages('13','SVM','2019','24');
ricegrowthstages('13','SVM','2020','1');
ricegrowthstages('13','SVM','2020','2');
ricegrowthstages('13','SVM','2020','3');
ricegrowthstages('13','SVM','2020','4');
ricegrowthstages('13','SVM','2020','5');
ricegrowthstages('13','SVM','2020','6');
ricegrowthstages('13','SVM','2020','7');
ricegrowthstages('13','SVM','2020','8');
ricegrowthstages('13','SVM','2020','9');
ricegrowthstages('13','SVM','2020','10');
ricegrowthstages('13','SVM','2020','11');
ricegrowthstages('13','SVM','2020','12');
ricegrowthstages('13','SVM','2020','13');
ricegrowthstages('13','SVM','2020','14');
ricegrowthstages('13','SVM','2020','15');
ricegrowthstages('13','SVM','2020','16');
ricegrowthstages('13','SVM','2020','17');
ricegrowthstages('13','SVM','2020','18');
