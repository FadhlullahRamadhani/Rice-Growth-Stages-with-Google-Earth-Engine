...
print(first_period)
 ...
 var first_period_str = first_period.replace(/\s/g, '');
  ...
  first_period_str = first_period_str.replace('-', '_');
  var name_file_fusion = 'IntegrationGEE16days_V3_'+ ml +'_ALL-' + first_period_str ;
  Export.image.toDrive({
    image: classified_S2_LS8_MOD13Q1_rename_MS_APPLIED1,
    folder : 'IntegrationGEE16days_V3_'+ml,
    crs:'EPSG:32748' ,
