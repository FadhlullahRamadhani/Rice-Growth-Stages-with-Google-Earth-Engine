...
function ricegrowthstages(code, ml, year, code_biweekly) {
  ...
  var name_file_fusion = 'FusionGEEBiWeekly_S2_V2_'+ ml +'_ALL-' + year +'_' + date_APPLIED1_code + '_W' + date_APPLIED1_data.week + '-' + date_APPLIED1_data.number ;
  Export.image.toDrive({
    image: classified_S2_APPLIED1,
    folder : 'FusionGEEBiWeekly_S2_V2_'+ml,
    crs:'EPSG:32748' ,
