...
function ricegrowthstages(code, ml, year, code_biweekly) {
  ...
  print('LS8SR_APPLIED1',LS8SR_APPLIED1)
  ...
  print('S2SR_APPLIED1',S2SR_APPLIED1)
 ...
 var MOD13Q1_APPLIED1 = ee.ImageCollection("MODIS/006/MOD13Q1");
  ...
  var name_file_fusion = 'FusionGEEBiWeekly_V2_'+ ml +'_JAVA-' + year +'_' + date_APPLIED1_code + '_W' + date_APPLIED1_data.week + '-' + date_APPLIED1_data.number ;
  Export.image.toDrive({
    image: classified_S2_LS8_MOD13Q1_rename_fusion_mask_APPLIED1_SLOPE,
    folder : 'FusionGEEBiWeekly_V2_JAVA_'+ml,
    crs:'EPSG:32748' ,
